...
importers:
  ...
  .:
    specifiers:
      ...
      vue: ^3.2.36
    dependencies:
      vitepress: 1.0.0-alpha.35_less@4.1.3
    devDependencies:
      '@vitejs/plugin-vue': 4.0.0_vite@4.0.3+vue@3.2.36
      less: 4.1.3
      typescript: 4.9.4
  ...
  examples:
    specifiers:
      dy-ui: workspace:^1.0.0
    dependencies:
      dy-ui: link:../packages/components

  packages/components:
    specifiers:
      '@dy-ui/utils': workspace:^1.0.0
    dependencies:
      '@dy-ui/utils': link:../utils
